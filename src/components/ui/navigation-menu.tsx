...
const NavigationMenu = UiForwardRef<typeof NavigationMenuPrimitive.Root>(
  ...
  {
    displayName: NavigationMenuPrimitive.Root.displayName,
  },
)

const NavigationMenuList = UiForwardRef<typeof NavigationMenuPrimitive.List>(
  ({ className, ...props }, ref) => (
  ...
  {
    displayName: NavigationMenuPrimitive.List.displayName,
  },
)
...
const NavigationMenuTrigger = UiForwardRef<typeof NavigationMenuPrimitive.Trigger>(
  ({ className, children, ...props }, ref) => (
  ...
  {
    displayName: NavigationMenuPrimitive.Trigger.displayName,
  },
)

const NavigationMenuContent = UiForwardRef<typeof NavigationMenuPrimitive.Content>(
  ({ className, ...props }, ref) => (
...
const NavigationMenuViewport = UiForwardRef<typeof NavigationMenuPrimitive.Viewport>(
  ({ className, ...props }, ref) => (
  ...
  {
    displayName: NavigationMenuPrimitive.Viewport.displayName,
  },
)

const NavigationMenuIndicator = UiForwardRef<typeof NavigationMenuPrimitive.Indicator>(
  ({ className, ...props }, ref) => (
  ...
  {
    displayName: NavigationMenuPrimitive.Indicator.displayName,
  },
)
