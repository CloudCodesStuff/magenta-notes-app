...
export function DeleteWorkspace({ workspace }: WorkspaceItemProps, props: CreateWorkspaceDialogProps) {
                        ...
                        <AlertDialogAction
                            onClick={async (event) => {
                                ...
                                mutation.mutate(workspace.id, {
                                    onSuccess() { utils.workspaces.getWorkspacesForCurrentUser.invalidate() },
                                })
                                console.log('dytf')
